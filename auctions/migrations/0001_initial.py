# Generated by Django 5.0.6 on 2024-08-11 20:58
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('user_comment', models.TextField(blank=True, max_length=10000, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('category', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, related_name='type', to='auctions.category')),
                ('comments', models.ManyToManyField(to='auctions.comment')),
                ('highest_bidder', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, related_name='best_customer', to=settings.AUTH_USER_MODEL)),
